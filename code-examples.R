...
# Attribution: https://rpubs.com/NickCHK/RTeach2020
...
## Questions
mynumber + 100
mynumber + mycharacter
as.character(mynumber) + mycharacter
"a" + "b"
myfactor
...
# Questions
# 1. Create a variable for a vector containing the series 100 to 200
